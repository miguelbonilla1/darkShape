      ...
      >
        ...
        <div className="w-full max-w-screen-xl p-5">
          <div className="text-center mb-5">
            <h1 className="text-5xl font-bold pb-5 md:pb-8 lg:pb-10 mb-5 lg:mb-10" style={{ textShadow: "2px 2px 5px rgba(0, 0, 0, 0.5)" }}>Cursos</h1>
          </div>
          <div className="text-center lg:text-left mb-5 lg:mb-10">
            <p className="text-xl sm:text-3xl lg:text-4xl text-gray-200 mb-5">
