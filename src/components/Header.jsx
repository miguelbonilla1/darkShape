...
const Header = () => {
  ...
  return (
    <header className="text-xl font-roboto sticky top-0 z-50 bg-gray-900 text-gray-300 dark:text-gray-200 shadow-md" style={{ maxHeight: '13vh' }}>
      <nav className="container mx-auto px-4 flex items-center justify-between lg:pr-10 h-full">
        ...
        <ul className="hidden md:flex items-center space-x-4 h-full flex-grow justify-center">
          <li className="text-2xl text-white dark:text-white hover:text-purple-500 dark:hover:text-blue-300 transition duration-300 cursor-pointer">
